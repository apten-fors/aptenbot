...
from utils.telegram_utils import send_message_with_retry, send_pic_with_retry
...
class CommandHandler:
    def __init__(self, session_manager: SessionManager, subscription_manager: SubscriptionManager, openai_client: OpenAIClient, flux_client: FluxClient):
